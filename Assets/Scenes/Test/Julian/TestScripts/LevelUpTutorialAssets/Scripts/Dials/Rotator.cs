...
namespace LevelUP.Dial
{
    ...
    {
        /*
        private HandFunctionality _handFunctionality;
        ...
        private XRBaseInteractor interactor; // todo find a substitute
        private float startAngle;
        private bool requiresStartAngle = true;
        private bool shouldGetHandRotation = false;
        private XRGrabInteractable grabInteractor => GetComponent<XRGrabInteractable>(); // todo find substitute

        private void Awake()
        {
            _handFunctionality = GetComponent<HandFunctionality>();
        }
