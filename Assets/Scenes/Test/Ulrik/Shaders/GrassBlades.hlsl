...
struct VertexOutput
{
    ...
    float4 postionCS    : SV_POSITION; // Position in clip space
};
...
VertexOutput Vertex(uint vertexID: SV_VertexID)
{
    ...
    //To get the triangle, and the module by 3 to get the vertex of the triangle
...
half4 Fragment(VertexOutput input) : SV_Target{
    ...
    // Lerp between the base and the tip color based on the blade height
